...
namespace Expenditure
{
    class HomeLoan: Expense
    {
        ...
        public  HomeLoan(double grossIncome, double monthlyTax, string option)
        {
        ...
        //this method checks if the monthly tax is less or more than the gross income
        public void CheckMonthlyTax(double monthlyTax, double grossIncome)
        {
            while (monthlyTax >= grossIncome)
            {
                Console.ForegroundColor = ConsoleColor.Red;
                Console.WriteLine("Error: Monthly Tax cannot be greater Gross Income");
                Console.ResetColor();
        ...
        public void CheckExpenses() { 
            ...
            for(int j=  0; j < monthlyExpenditures.Length; j++)
            {
        ...
        public double GetExpenditureTotal()
        {
            ...
            {
                totalMonthlyExpenditure = totalMonthlyExpenditure + rentAmount;
            }
            else if (option.ToUpper().Equals("B"))
            {
                totalMonthlyExpenditure = totalMonthlyExpenditure + monthlyRepayment;
            }
